class Event < ActiveRecord::Base
  ...
  def voting_enabled?
    return self.voting_enabled && (self.voting_end_date.nil? ? true : Date.today < self.voting_end_date.to_date) && Date.today < self.start_date.to_date
  end
  ...
  def volunteering_enabled?
    return self.volunteering_enabled && (self.volunteer_end_date.nil? ? true : Date.today < self.volunteer_end_date.to_date) && Date.today <= self.end_date.to_date
  end
